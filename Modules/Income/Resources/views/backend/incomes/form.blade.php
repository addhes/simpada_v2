...
<div class="form-group row">
    <label class="col-lg-2 col-form-label" for="title">Pendapatan <span class="wajib">*</span></label>
    <div class="col-lg-10">
        <input type="text" class="form-control" id="title" name="title" placeholder="Cth: Pendapatan dari . . ."
...
<div class="form-group row">
    ...
    <div class="col-lg-10">
        <input type="text" class="form-control" id="description" name="description" placeholder="Pendapatan bulan . . ."
            value="{{ $$module_name_singular->description ?? '' }}" required>
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="tbl_posts">
                    ...
                    <tbody id="tbl_posts_body">
                        @if(count($incomedetail ?? []) > 0)
                        @foreach($incomedetail ?? [] as $index => $item)
                        @php
                        $index += 1;
                        @endphp
                        <tr id="rec-{{ $index }}">

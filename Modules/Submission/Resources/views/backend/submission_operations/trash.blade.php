        ...
        <div class="row">
            ...
            <div class="col">
                {{-- <div class="float-right">
                    <a class="btn" style="background-color: #c3c3c3"><i class="fa fa-archive"></i></a>
                </div> --}}
            </div>
            <!--/.col-->
        </div>
    ...
    $(document).ready(function() {
        ...
        // console.log(result)
            if (result.isConfirmed) {
                $.ajax({
                type: 'DELETE',
                url: '/admin/submission_operations/forcedelete/' + dataId,
...
<script type="text/javascript">
    ...
    table = $('#datatable').DataTable({
        ...
        ajax: {
            'url': '{{ url("admin/submission_operations/trashed_index_list") }}',
            'data': function(d) {
                d.bulan = $("#bulan").val()
            },
        },

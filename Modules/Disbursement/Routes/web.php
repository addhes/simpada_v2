...
// Disbursement
Route::group(['namespace' => '\Modules\Disbursement\Http\Controllers\Backend', 'as' => 'backend.', 'middleware' => ['web', 'auth', 'can:view_backend'], 'prefix' => 'admin'], function () {
    $module_name = 'disbursements';
    $controller_name = 'DisbursementController';

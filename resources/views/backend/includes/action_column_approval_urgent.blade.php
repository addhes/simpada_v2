<div class="text-right">
    ...
    <x-buttons.reject route='{!!route("backend.$module_name.reject", $data->id)!!}' dataid="{{ $data->id }}"
        id="btnReject" title="{{__('Reject')}} {{ ucwords(Str::singular($module_name)) }}" small="true" />
    @endif
